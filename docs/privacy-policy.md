...
- **Application** refers to Run Scorer, the software program provided by the Company.

- **Company** (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Canopas Software LLP.
...
- By email: [contact@canopas.com](mailto:contact@canopas.com)
